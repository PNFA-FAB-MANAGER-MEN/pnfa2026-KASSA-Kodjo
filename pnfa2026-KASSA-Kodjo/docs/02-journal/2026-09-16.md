...
- Tentative d'intégration d'un écran ILI TFT parallèle (Shield 2.4") comme interface d'affichage principale du robot. ![TFT_shield](../medias/ilishield.jpeg) ![TFT_shield](../medias/ilishield2.jpeg)
...
- Problèmes d'affichage et de rendu des polices de caractères avec la bibliothèque de l'écran ILI TFT parallèle.
